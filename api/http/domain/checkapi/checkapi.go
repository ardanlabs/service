...
func (api *api) readiness(ctx context.Context, w http.ResponseWriter, r *http.Request) (web.Encoder, error) {
...
func (api *api) liveness(ctx context.Context, w http.ResponseWriter, r *http.Request) (web.Encoder, error) {
