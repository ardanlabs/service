...
var (
	...
	ErrStoreMissingRecord = errors.New("sturdyc: the record will be marked as missing in the cache")
	...
	ErrDeleteRecord = errors.New("sturdyc: the record has been deleted at the data source")
)
