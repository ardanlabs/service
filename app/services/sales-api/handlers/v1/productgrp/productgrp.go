...
// service:webapi POST /products AppNewProduct AppProduct http.StatusCreated
...
// service:webapi POST /products/:product_id AppUpdateProduct AppProduct http.StatusOK
