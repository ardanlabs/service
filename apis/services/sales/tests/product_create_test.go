...
func productCreate200(sd dbtest.SeedData) []apptest.AppTable {
...
func productCreate400(sd dbtest.SeedData) []apptest.AppTable {
	table := []apptest.AppTable{
		{
			Name:       "missing-input",
			URL:        "/v1/products",
...
func productCreate401(sd dbtest.SeedData) []apptest.AppTable {
	table := []apptest.AppTable{
		{
			Name:       "emptytoken",
			URL:        "/v1/products",
