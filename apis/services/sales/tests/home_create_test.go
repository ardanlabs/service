...
func homeCreate200(sd dbtest.SeedData) []apptest.AppTable {
...
func homeCreate400(sd dbtest.SeedData) []apptest.AppTable {
	table := []apptest.AppTable{
		{
			Name:       "missing-input",
			URL:        "/v1/homes",
...
func homeCreate401(sd dbtest.SeedData) []apptest.AppTable {
	table := []apptest.AppTable{
		{
			Name:       "emptytoken",
			URL:        "/v1/homes",
